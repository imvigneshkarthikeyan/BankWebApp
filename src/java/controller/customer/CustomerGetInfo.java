 ...
 */
//@WebServlet(name = "CustomerGetInfoServlet", urlPatterns = {"/getcustomerinfo"})
public class CustomerGetInfo implements Action, ServletRequestAware,ServletResponseAware {
    ...
    public String execute() throws ServletException, IOException {
        try {
            ...
            if (utilities.Validator.isUserCustomer(userID, response)) {
                ...
                json.put("phone", resultSet.getString("phone_num"));
